...
const  baseUrl = "http://localhost:8080/api/v1/motherboards"
...
const addMotherboardToPc = async (motherboardId, pc_Id) =>{
    const response = await fetch(`${baseUrl}/${motherboardId}/${pc_Id}`, {
        method: 'POST',
        headers: headers
    })
        .catch(err => console.error(err.message))
...
const createProductCards = (arr) =>{
    ...
    arr.forEach(obj =>{
        ...
        <div class="card-body d-flex flex-column justify-content-between">
            ...
            <div>
                <button onclick="addMotherboardToPc(${obj.id}, pcId)" class="btn btn-primary">Add To Pc</button>
